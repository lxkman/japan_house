...
public class ZhaoxiaoquActivity_ViewBinding implements Unbinder {
  private ZhaoxiaoquActivity target;
  ...
  @UiThread
  public ZhaoxiaoquActivity_ViewBinding(ZhaoxiaoquActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ZhaoxiaoquActivity_ViewBinding(final ZhaoxiaoquActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ZhaoxiaoquActivity target = this.target;
