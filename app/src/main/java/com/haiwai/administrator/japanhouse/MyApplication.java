...
import com.haiwai.administrator.japanhouse.im.TalkExtensionModule;
...
//                Toast.makeText(getContext(), "友盟推送注册失败", Toast.LENGTH_SHORT).show();
    ...
    public static int getSwitchState() {
        com.haiwai.administrator.japanhouse.model.UserInfo.DatasBean.UserBean userBean = CacheUtils.get(Constants.P_USERINFO);
        if (userBean != null) {
