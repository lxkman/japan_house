...
public class ZuHousedetailsActivity_ViewBinding implements Unbinder {
  private ZuHousedetailsActivity target;
  ...
  @UiThread
  public ZuHousedetailsActivity_ViewBinding(ZuHousedetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ZuHousedetailsActivity_ViewBinding(final ZuHousedetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ZuHousedetailsActivity target = this.target;
