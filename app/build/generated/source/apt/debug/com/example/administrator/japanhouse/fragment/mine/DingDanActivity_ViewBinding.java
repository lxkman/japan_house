...
public class DingDanActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public DingDanActivity_ViewBinding(DingDanActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public DingDanActivity_ViewBinding(final DingDanActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DingDanActivity target = this.target;
