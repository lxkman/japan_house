...
import com.haiwai.administrator.japanhouse.fragment.mine.fragment.LiShiJiLu2Activity;
        ...
        OkGo.<ZuHouseShaiXuanBean>post(MyUrls.BASEURL + "/app/twoscreening/selectallscree")
                ...
                .execute(new JsonCallback<ZuHouseShaiXuanBean>(ZuHouseShaiXuanBean.class) {
                    ...
                    public void onSuccess(Response<ZuHouseShaiXuanBean> response) {
                        ...
                        firstView = new FirstView(ZufangListActivity.this);
                        popupViews.add(firstView.firstView());
                        secView = new SecView(ZufangListActivity.this);
                        popupViews.add(secView.secView());
                        threeView = new ThreeView(ZufangListActivity.this);
                        popupViews.add(threeView.firstView());
                        fourView = new MoreView(ZufangListActivity.this);
