...
import com.haiwai.administrator.japanhouse.more.JiuDianMoreActivity;
...
public class JiudianDetailsActivity extends UMShareActivity {
    ...
    class LoveAdapter extends BaseQuickAdapter<SydcListBean.DatasEntity, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, SydcListBean.DatasEntity item) {
            ...
            Glide.with(JiudianDetailsActivity.this).load(TextUtils.isEmpty(item.getVideoImgs()) ?
                    MyUtils.getSpiltText(item.getRealEstateImgs()) : item.getVideoImgs()).into((ImageView) helper.getView(R.id.img_house));
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.manager_data:
                ...
                Intent Managerintent = new Intent(JiudianDetailsActivity.this, ManagerActivity.class);
    ...
    private void showDialog(int grary, int animationStyle) {
        final String url = "http://www.flcjapan.com/hwdch5/info/houtelDetails.html?id=" + houseId;
        BaseDialog.Builder builder = new BaseDialog.Builder(this);
        //设置触摸dialog外围是否关闭
        //设置监听事件
        ...
        weixin_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareWebUrl(url, isJa ? datas.getTitleJpn() : datas.getTitleCn()
                        ...
                        JiudianDetailsActivity.this, SHARE_MEDIA.WEIXIN);
            }
        });
        //朋友圈分享
        pengyouquan_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareWebUrl(url, isJa ? datas.getTitleJpn() : datas.getTitleCn()
                        , TextUtils.isEmpty(datas.getVideoImgs()) ? datas.getRealEstateImgs() : datas.getVideoImgs()
                        , isJa ? datas.getAreaJpn() : datas.getAreaCn(),
                        JiudianDetailsActivity.this, SHARE_MEDIA.WEIXIN_CIRCLE);
            }
        });
        //微博分享
        weibo_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareWebUrl(url, isJa ? datas.getTitleJpn() : datas.getTitleCn()
                        , TextUtils.isEmpty(datas.getVideoImgs()) ? datas.getRealEstateImgs() : datas.getVideoImgs()
                        , isJa ? datas.getAreaJpn() : datas.getAreaCn(),
                        JiudianDetailsActivity.this, SHARE_MEDIA.SINA);
            }
        });
        //取消
