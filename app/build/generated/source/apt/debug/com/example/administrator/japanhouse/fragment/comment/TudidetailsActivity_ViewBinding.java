...
public class TudidetailsActivity_ViewBinding implements Unbinder {
  private TudidetailsActivity target;
  ...
  @UiThread
  public TudidetailsActivity_ViewBinding(TudidetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TudidetailsActivity_ViewBinding(final TudidetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TudidetailsActivity target = this.target;
