...
import com.haiwai.administrator.japanhouse.more.TuanDiMoreActivity;
...
public class XiaoQuDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xiao_qu_details);
        //拉伸图片覆盖标题栏
    ...
    private void initStart() {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(XiaoQuDetailsActivity.this, SuccessBean.class) {
                    @Override
