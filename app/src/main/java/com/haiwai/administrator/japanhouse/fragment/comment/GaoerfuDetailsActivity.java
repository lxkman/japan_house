...
import com.haiwai.administrator.japanhouse.more.GaoErFuMoreActivity;
...
import static com.haiwai.administrator.japanhouse.R.id.tv_price;

public class GaoerfuDetailsActivity extends UMShareActivity {
...
//            helper.setText(R.id.tv_house_room,isJa?item.getDoorModelJpn():item.getDoorModelCn());
            ...
            Glide.with(GaoerfuDetailsActivity.this).load(TextUtils.isEmpty(item.getVideoImgs()) ?
