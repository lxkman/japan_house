...
//        setTitle("地理位置");
        TextView mRightButton = (TextView) findViewById(R.id.act_map_send);
        ...
        mMapView = (MapView) findViewById(R.id.act_map_bmapView);
        ...
        try {
            ...
            if (mMsg != null) {
//                Maplistviewview.setVisibility(View.GONE);
