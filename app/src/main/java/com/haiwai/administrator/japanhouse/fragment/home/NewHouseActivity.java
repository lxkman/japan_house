        ...
        OkGo.<OldHouseShaiXuanBean>post(MyUrls.BASEURL + "/app/onescreening/selectallscree")
                ...
                .execute(new JsonCallback<OldHouseShaiXuanBean>(OldHouseShaiXuanBean.class) {
                    ...
                    public void onSuccess(Response<OldHouseShaiXuanBean> response) {
                        ...
                        firstView = new FirstView(NewHouseActivity.this);
                        popupViews.add(firstView.firstView());
                        secView = new SecView(NewHouseActivity.this);
                        popupViews.add(secView.secView());
                        threeView = new ThreeView(NewHouseActivity.this);
                        popupViews.add(threeView.firstView());
                        fourView = new MoreView(NewHouseActivity.this);
...
//                        popupViews.add(secView.secView());
                        secView.setListener(NewHouseActivity.this);
...
//                        ThreeView threeView = new ThreeView(NewHouseActivity.this);
//                        popupViews.add(threeView.firstView());
                        threeView.insertData(list2, dropDownMenu);
                        threeView.setListener(NewHouseActivity.this);
                        /**
                         * 第四个界面
                         * */
...
//                        popupViews.add(fourView.secView());
                        ...
                        fourView.setListener(NewHouseActivity.this);
                        /**
                         * Dropdownmenu下面的主体部分
                         * */
//                        dropDownMenu.setDropDownMenu(Arrays.asList(headers), popupViews, fifthView);
    ...
    private void initData() {
        ...
        OkGo.<OldHouseListBean>post(MyUrls.BASEURL + "/app/houseresourse/searchlist")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<OldHouseListBean>(NewHouseActivity.this, OldHouseListBean.class) {
                    @Override
