...
public class HaiWaiDetailsActivity_ViewBinding implements Unbinder {
  private HaiWaiDetailsActivity target;
  ...
  @UiThread
  public HaiWaiDetailsActivity_ViewBinding(HaiWaiDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public HaiWaiDetailsActivity_ViewBinding(final HaiWaiDetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HaiWaiDetailsActivity target = this.target;
