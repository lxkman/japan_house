...
public class MyGridViewAdpter extends BaseAdapter {
	...
	private List<HomeItemBean> lists;//数据源
	private int mIndex; // 页数下标，标示第几页，从0开始
	private int mPargerSize;// 每页显示的最大的数量
	
	
	
	public MyGridViewAdpter(Context context, List<HomeItemBean> lists,
	...
	@Override
	public HomeItemBean getItem(int arg0) {
		// TODO Auto-generated method stub
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = View.inflate(context, R.layout.item_grid_page, null);
			holder.tv_name = (TextView)convertView.findViewById(R.id.item_title_tv);
			holder.iv_nul = (ImageView)convertView.findViewById(R.id.item_icon_iv);
		...
		holder.tv_name.setText(lists.get(pos).getTitle());
		holder.iv_nul.setImageResource(lists.get(pos).getImg());
		//添加item监听
