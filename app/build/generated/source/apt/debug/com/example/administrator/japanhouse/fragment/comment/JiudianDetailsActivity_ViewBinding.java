...
public class JiudianDetailsActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public JiudianDetailsActivity_ViewBinding(JiudianDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public JiudianDetailsActivity_ViewBinding(final JiudianDetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    JiudianDetailsActivity target = this.target;
