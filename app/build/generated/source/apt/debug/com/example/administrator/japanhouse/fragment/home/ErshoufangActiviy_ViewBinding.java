...
public class ErshoufangActiviy_ViewBinding implements Unbinder {
  private ErshoufangActiviy target;
  ...
  @UiThread
  public ErshoufangActiviy_ViewBinding(ErshoufangActiviy target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ErshoufangActiviy_ViewBinding(final ErshoufangActiviy target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ErshoufangActiviy target = this.target;
