...
public class ZufangListActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ZufangListActivity_ViewBinding(ZufangListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ZufangListActivity_ViewBinding(final ZufangListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ZufangListActivity target = this.target;
