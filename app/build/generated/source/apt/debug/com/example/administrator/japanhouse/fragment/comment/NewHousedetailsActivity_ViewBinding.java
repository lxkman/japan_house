...
public class NewHousedetailsActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public NewHousedetailsActivity_ViewBinding(NewHousedetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public NewHousedetailsActivity_ViewBinding(final NewHousedetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    NewHousedetailsActivity target = this.target;
