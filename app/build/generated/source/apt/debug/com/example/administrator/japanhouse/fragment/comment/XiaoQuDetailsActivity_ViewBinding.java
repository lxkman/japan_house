...
public class XiaoQuDetailsActivity_ViewBinding implements Unbinder {
  private XiaoQuDetailsActivity target;
  ...
  @UiThread
  public XiaoQuDetailsActivity_ViewBinding(XiaoQuDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public XiaoQuDetailsActivity_ViewBinding(final XiaoQuDetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    XiaoQuDetailsActivity target = this.target;
