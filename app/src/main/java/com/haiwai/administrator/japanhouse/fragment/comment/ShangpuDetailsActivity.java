...
import com.haiwai.administrator.japanhouse.more.ShangPuMoreActivity;
...
public class ShangpuDetailsActivity extends UMShareActivity {
    ...
    private void initDetailsNet() {
        ...
        new HouseLogPresenter(this).setHouseLog("5",houseId,"3");
...
//            helper.setText(R.id.tv_house_room,isJa?item.getDoorModelJpn():item.getDoorModelCn());
            ...
            Glide.with(ShangpuDetailsActivity.this).load(TextUtils.isEmpty(item.getVideoImgs()) ?
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.manager_data:
                Intent Managerintent = new Intent(ShangpuDetailsActivity.this, ManagerActivity.class);
    ...
    private void showDialog(int grary, int animationStyle) {
        final String url="http://www.flcjapan.com/hwdch5/info/shopsDetails.html?id="+houseId;
        BaseDialog.Builder builder = new BaseDialog.Builder(this);
        //设置触摸dialog外围是否关闭
        //设置监听事件
        ...
        weixin_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareWebUrl(url, isJa?datas.getTitleJpn():datas.getTitleCn()
                        ...
                        ShangpuDetailsActivity.this, SHARE_MEDIA.WEIXIN);
            }
        });
        //朋友圈分享
        pengyouquan_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareWebUrl(url, isJa?datas.getTitleJpn():datas.getTitleCn()
                        , TextUtils.isEmpty(datas.getVideoImgs())?datas.getRealEstateImgs():datas.getVideoImgs()
                        , isJa?datas.getAreaJpn():datas.getAreaCn(),
                        ShangpuDetailsActivity.this, SHARE_MEDIA.WEIXIN_CIRCLE);
            }
        });
        //微博分享
        weibo_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                shareWebUrl(url, isJa?datas.getTitleJpn():datas.getTitleCn()
                        , TextUtils.isEmpty(datas.getVideoImgs())?datas.getRealEstateImgs():datas.getVideoImgs()
                        , isJa?datas.getAreaJpn():datas.getAreaCn(),
                        ShangpuDetailsActivity.this, SHARE_MEDIA.SINA);
            }
        });
        //取消
