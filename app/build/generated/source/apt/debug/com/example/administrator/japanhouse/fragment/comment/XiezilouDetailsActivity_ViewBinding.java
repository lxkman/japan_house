...
public class XiezilouDetailsActivity_ViewBinding implements Unbinder {
  private XiezilouDetailsActivity target;
  ...
  @UiThread
  public XiezilouDetailsActivity_ViewBinding(XiezilouDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public XiezilouDetailsActivity_ViewBinding(final XiezilouDetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    XiezilouDetailsActivity target = this.target;
