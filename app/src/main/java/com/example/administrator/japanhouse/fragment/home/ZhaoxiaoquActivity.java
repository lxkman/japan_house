                ...
                .execute(new DialogCallback<OldHouseListBean>(ZhaoxiaoquActivity.this, OldHouseListBean.class) {
                    ...
                    public void onSuccess(Response<OldHouseListBean> response) {
                        ...
                        if (mDatas == null || mDatas.size() == 0) {
                            ...
                            if (datas == null || datas.size() == 0) {
                                Toast.makeText(ZhaoxiaoquActivity.this, R.string.meiyougengduoshujule, Toast.LENGTH_SHORT).show();
                                return;
                            }
                            if (!isLoadMore) {
                                mDatas = datas;
                                Toast.makeText(ZhaoxiaoquActivity.this, R.string.shuaxinchenggong, Toast.LENGTH_SHORT).show();
                            } else {
                                mDatas.addAll(datas);
                            }
                            liebiaoAdapter.notifyDataSetChanged();
