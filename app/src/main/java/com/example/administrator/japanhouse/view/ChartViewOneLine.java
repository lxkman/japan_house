package com.example.administrator.japanhouse.view;
...
public class ChartViewOneLine extends HorizontalScrollView {
    ...
    private void initPaint() {
        ...
        linePaint2.setStrokeWidth(dpToPx(2));
...
//                drawFloatTextBox(canvas, x, y - dp7, int(value.get(xValue.get(i)));
            }
            //绘制普通的节点
            linePaint.setStyle(Paint.Style.FILL);
...
//    }
    ...
    public void setValueTwoLine(Map<String, Float> value, Map<String, Float> value1,List<String> xValue, List<Float> yValue) {
        this.value = value;
        this.value1 = value1;
        this.xValue = xValue;
        this.yValue = yValue;
    ...
    public void setValueOneLine(Map<String, Float> value,List<String> xValue, List<Float> yValue) {
        this.value = value;
        this.xValue = xValue;
        this.yValue = yValue;
        invalidate();
