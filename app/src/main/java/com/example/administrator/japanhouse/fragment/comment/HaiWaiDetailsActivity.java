...
public class HaiWaiDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.haiwai_wl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferencesUtils.getInstace(HaiWaiDetailsActivity.this).setStringPreference(Constant.CHAT, Constant.CHAT_DETAILS);
    ...
    private void initLoveRecycler() {
        ...
        loveRecycler.setLayoutManager(new LinearLayoutManager(HaiWaiDetailsActivity.this, LinearLayoutManager.VERTICAL, false));
