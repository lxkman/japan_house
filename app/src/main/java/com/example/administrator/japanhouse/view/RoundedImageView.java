...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_borderWidth, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView_borderColor);
        if (borderColor == null) {
