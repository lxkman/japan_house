...
import com.example.administrator.japanhouse.more.JiuDianMoreActivity;
...
public class JiudianDetailsActivity extends BaseActivity {
    ...
    private void initDetailsNet() {
        ...
        new HouseLogPresenter(this).setHouseLog("5",houseId,"0");
...
//        if (houseId!=null&&!houseId.equals("")){
        ...
        OkGo.<ShangYeDetailsBean>post(MyUrls.BASEURL + "/app/realestate/realestateinfo")
                ...
                .execute(new DialogCallback<ShangYeDetailsBean>(this, ShangYeDetailsBean.class) {
                    ...
                    public void onSuccess(Response<ShangYeDetailsBean> response) {
                        ...
                        Glide.with(JiudianDetailsActivity.this).load(hwdcBroker.getPic() + "").into(tvDetailsManagerHead);
                        isSc = datas.getIsSc();
                        if (isSc == 0) {//收藏
                            isStart = true;
    ...
    private void initData() {
        findViewById(R.id.jiudian_wl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferencesUtils.getInstace(JiudianDetailsActivity.this).setStringPreference(Constants.CHAT, Constants.CHAT_DETAILS);
                setMyExtensionModule();
                if (RongIM.getInstance() != null) {
                    Log.e("MainActivity", "创建单聊");
                    RongIM.getInstance().startPrivateChat(JiudianDetailsActivity.this, "123456", getString(R.string.act_chat_title));
                }
            }
        });
    }
    ...
    private void initLoveRecycler() {
        ...
        OkGo.<SydcListBean>post(MyUrls.BASEURL + "/app/realestate/searchlist")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SydcListBean>(JiudianDetailsActivity.this, SydcListBean.class) {
                    @Override
                    public void onSuccess(Response<SydcListBean> response) {
                        ...
                        loveAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                                Intent intent = new Intent(JiudianDetailsActivity.this, JiudianDetailsActivity.class);
...
//            helper.setText(R.id.tv_house_room,isJa?item.getDoorModelJpn():item.getDoorModelCn());
            ...
            Glide.with(JiudianDetailsActivity.this).load(item.getRealEstateImgs()).into((ImageView) helper.getView(R.id.img_house));
        }
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_details_location:
                ...
                if (checkMapAppsIsExist(JiudianDetailsActivity.this, BAIDU_PKG)) {
                    ...
                    Toast.makeText(JiudianDetailsActivity.this, "百度地图未安装或版本过低", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.img_start:
            ...
            case R.id.tv_See_More:
                Intent intent = new Intent(JiudianDetailsActivity.this, JiuDianMoreActivity.class);
    ...
    private void initStart() {
        ...
        params.put("shType", "0");//房源类型下的小类型 例：租房下的二层公寓传3 租房（0办公室出租 1商铺出租 2别墅 3二层公寓 4学生公寓详情 5多层公寓详情） 商业地产（0酒店 1高尔夫球场 2写字楼 3商铺）
        params.put("hId", houseId);
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(JiudianDetailsActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            imgStart.setImageResource(R.drawable.shoucang2);
                            Toast.makeText(JiudianDetailsActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(JiudianDetailsActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/deletecollectionhouse")
                ...
                .execute(new DialogCallback<SuccessBean>(JiudianDetailsActivity.this, SuccessBean.class) {
                    ...
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            imgStart.setImageResource(R.drawable.shoucang);
                            Toast.makeText(JiudianDetailsActivity.this, "取消收藏成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(JiudianDetailsActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
