...
public class ShangpuDetailsActivity_ViewBinding implements Unbinder {
  private ShangpuDetailsActivity target;
  ...
  @UiThread
  public ShangpuDetailsActivity_ViewBinding(ShangpuDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ShangpuDetailsActivity_ViewBinding(final ShangpuDetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ShangpuDetailsActivity target = this.target;
