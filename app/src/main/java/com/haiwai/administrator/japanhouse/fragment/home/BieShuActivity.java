...
public class BieShuActivity extends BaseActivity implements MyItemClickListener {
    ...
    private void initView() {
        ...
        inflate = LayoutInflater.from(this).inflate(R.layout.activity_main_view, null);
        mrecycler = (RecyclerView) inflate.findViewById(R.id.mrecycler);
        ...
        OkGo.<OldHouseShaiXuanBean>post(MyUrls.BASEURL + "/app/onescreening/selectallscree")
                ...
                .execute(new JsonCallback<OldHouseShaiXuanBean>(OldHouseShaiXuanBean.class) {
                    ...
                    public void onSuccess(Response<OldHouseShaiXuanBean> response) {
                        ...
                        firstView = new FirstView(BieShuActivity.this);
                        popupViews.add(firstView.firstView());
                        secView = new SecView(BieShuActivity.this);
                        popupViews.add(secView.secView());
                        threeView = new ThreeView(BieShuActivity.this);
                        popupViews.add(threeView.firstView());
                        fourView = new MoreView(BieShuActivity.this);
                        popupViews.add(fourView.secView());
                        dropDownMenu.setDropDownMenu(Arrays.asList(headers), popupViews, inflate);
                        initShaiXuan();
                    }
                });
    }
