    ...
    public void onBindViewHolder(final Viewholder holder, int position) {
          holder.view.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  //跳转
                 RentalDetailsActivity.invoke(context,new RentalDetailsBean(context.getString(R.string.sell_details),1,null,null,null,holder.weizhi.getText().toString(),holder.juli.getText().toString(),null,holder.mianji.getText().toString(),null,null,holder.chaoxiang.getText().toString(),null,null,null, 0));
              }
          });
    }
