...
public class ChineseFangyuanActivity_ViewBinding implements Unbinder {
  private ChineseFangyuanActivity target;
  ...
  @UiThread
  public ChineseFangyuanActivity_ViewBinding(ChineseFangyuanActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChineseFangyuanActivity_ViewBinding(final ChineseFangyuanActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChineseFangyuanActivity target = this.target;
