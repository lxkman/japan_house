...
public class NewHouseMoreActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_house_zonghushu)
    TextView tvHouseZonghushu;
    ...
    @BindView(R.id.tv_house_chuangwaifengjing)
    TextView tvHouseChuangwaifengjing;
    ...
    private void initData() {
        ...
        tvDongcengNum.setText(ja ? datas.getFloorJpn() : datas.getFloorCn());/*楼层*/
        ...
        tvHouseZonghushu.setText(ja ? datas.getHouseholdsJpn() : datas.getHouseholdsCn());/*总户数*/
        ...
        tvHouseChuangwaifengjing.setText(ja ? datas.getSceneryJpn() : datas.getSceneryCn());/*窗外风景*/
        ...
        tvHouseShebei.setText(ja ? datas.getIndoorEquipmentJpn() : datas.getIndoorEquipmentCn());/*室内设备*/
