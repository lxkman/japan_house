...
public class HaiWaiActivity_ViewBinding implements Unbinder {
  private HaiWaiActivity target;
  ...
  @UiThread
  public HaiWaiActivity_ViewBinding(HaiWaiActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public HaiWaiActivity_ViewBinding(final HaiWaiActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HaiWaiActivity target = this.target;
