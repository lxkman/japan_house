...
import com.haiwai.administrator.japanhouse.bean.MapHouseBean;
import com.haiwai.administrator.japanhouse.bean.MapHouseDetailBean;
import com.haiwai.administrator.japanhouse.bean.MarkerBean;
...
import com.haiwai.administrator.japanhouse.view.MyDrawCircleView;
...
public class MapNewhouseFragment extends BaseFragment implements MyItemClickListener, View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.e("xxx", "fragment333" + " oncreateView()");
        return view;
    }
    ...
    public void onDestroy() {
        ...
        Log.e("xxx", "fragment333" + " onDestroy()");
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        Log.e("xxx", "fragment333" + " onActivityCreated()");
        initData();
        initLocation();
        initListener();
    }
        ...
        OkGo.<QuYuBean>post(MyUrls.BASEURL + "/app/areamanage/selectareaandsubway")
                ...
                .execute(new JsonCallback<QuYuBean>(QuYuBean.class) {
                    ...
                    public void onSuccess(Response<QuYuBean> response) {
                        ...
                        fourView.insertData(moreCheckBeanList, dropDownMenu, "newhouse");
                        fourView.setListener(MapNewhouseFragment.this);
                        /**
                         * Dropdownmenu下面的主体部分
                         * */
                        Log.e("xxx", "33333333333333333333333");
    ...
    public void onResume() {
        super.onResume();
        Log.e("xxx", "fragment333" + " onResume()");
        mapView.onResume();
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        Log.e("xxx", "fragment333" + " onDestroyView()");
        mapView.onDestroy();
    }
