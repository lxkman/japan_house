...
public class ToutiaoAdapter extends RecyclerView.Adapter<ToutiaoAdapter.ViewHolder> {
    Context context;
    List<com.haiwai.administrator.japanhouse.bean.TouListBean.DatasBean> datas;
    ...
    public ToutiaoAdapter(Context context, List<com.haiwai.administrator.japanhouse.bean.TouListBean.DatasBean> datas) {
