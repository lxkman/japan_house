...
public class MineBindPhoneActivity_ViewBinding implements Unbinder {
  private MineBindPhoneActivity target;

  @UiThread
  public MineBindPhoneActivity_ViewBinding(MineBindPhoneActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MineBindPhoneActivity_ViewBinding(MineBindPhoneActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MineBindPhoneActivity target = this.target;
