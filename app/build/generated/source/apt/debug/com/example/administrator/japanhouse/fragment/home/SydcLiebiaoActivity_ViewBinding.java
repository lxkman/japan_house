...
public class SydcLiebiaoActivity_ViewBinding implements Unbinder {
  private SydcLiebiaoActivity target;
  ...
  @UiThread
  public SydcLiebiaoActivity_ViewBinding(SydcLiebiaoActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SydcLiebiaoActivity_ViewBinding(final SydcLiebiaoActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SydcLiebiaoActivity target = this.target;
