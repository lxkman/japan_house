...
public class ChineseLiebiaoActivity_ViewBinding implements Unbinder {
  private ChineseLiebiaoActivity target;
  ...
  @UiThread
  public ChineseLiebiaoActivity_ViewBinding(ChineseLiebiaoActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ChineseLiebiaoActivity_ViewBinding(final ChineseLiebiaoActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChineseLiebiaoActivity target = this.target;
