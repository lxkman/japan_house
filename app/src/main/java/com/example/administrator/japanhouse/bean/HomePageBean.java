...
public class HomePageBean {
    ...
    public static class DatasEntity {
        ...
        private List<TjxfEntity> tjxf;
        private List<TjzfEntity> tjzf;
        ...
        public void setTjxf(List<TjxfEntity> tjxf) {
            this.tjxf = tjxf;
        }

        public void setTjzf(List<TjzfEntity> tjzf) {
            this.tjzf = tjzf;
        }

        public void setCnxh(List<CnxhEntity> cnxh) {
            this.cnxh = cnxh;
        }

        public void setTjesf(List<TjesfEntity> tjesf) {
            this.tjesf = tjesf;
        }
        ...
        public List<TjxfEntity> getTjxf() {
            return tjxf;
        }

        public List<TjzfEntity> getTjzf() {
            return tjzf;
        }

        public List<CnxhEntity> getCnxh() {
            return cnxh;
        }

        public List<TjesfEntity> getTjesf() {
            return tjesf;
        }

        public List<TjjjrEntity> getTjjjr() {
            return tjjjr;
        }
        ...
        public static class TjtdEntity {
            ...
            public static class ImageListEntity {
                /**
                 * val : https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1526960221&di=d5a70cd88be67479c20836cbdb04c46d&src=http://www.08lr.cn/uploads/allimg/170513/1-1F513100951.jpg
                 */
                private String val;
        ...
        public static class TjxfEntity {
            /**
        ...
        public static class TjzfEntity {
            /**
             * specificLocationCn : 1
             * areaCn : 100
             * videoImgs : https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1527055539469&di=2767442bde9416f0f4110731a704eae5&imgtype=0&src=http%3A%2F%2Fg.hiphotos.baidu.com%2Fimage%2Fpic%2Fitem%2F03087bf40ad162d97cc5dcbe1ddfa9ec8a13cd6d.jpg
        ...
        public static class CnxhEntity {
            /**
             * specificLocationCn : 1
             * areaCn : 100
             * videoImgs : https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1527055539469&di=2767442bde9416f0f4110731a704eae5&imgtype=0&src=http%3A%2F%2Fg.hiphotos.baidu.com%2Fimage%2Fpic%2Fitem%2F03087bf40ad162d97cc5dcbe1ddfa9ec8a13cd6d.jpg
        ...
        public static class TjesfEntity {
            /**
             * specificLocationCn : 1
             * areaCn : 100
             * videoImgs : https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1527055539469&di=2767442bde9416f0f4110731a704eae5&imgtype=0&src=http%3A%2F%2Fg.hiphotos.baidu.com%2Fimage%2Fpic%2Fitem%2F03087bf40ad162d97cc5dcbe1ddfa9ec8a13cd6d.jpg
        ...
        public static class TjjjrEntity {
            /**
             * period : 1
             * shop : 所属门店
             * counts : 60
