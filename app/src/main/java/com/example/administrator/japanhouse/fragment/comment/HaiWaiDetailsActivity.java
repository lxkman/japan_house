...
public class HaiWaiDetailsActivity extends BaseActivity {
    ...
    private void initLoveRecycler() {
        ...
        OkGo.<ChinaListBean>post(MyUrls.BASEURL + "/app/oiverseas/searchlist")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<ChinaListBean>(HaiWaiDetailsActivity.this, ChinaListBean.class) {
                    @Override
...
//            helper.setText(R.id.tv_house_room,isJa?item.getDoorModelJpn():item.getDoorModelCn());
            ...
            Glide.with(HaiWaiDetailsActivity.this).load(item.getHouseImgs()).into((ImageView) helper.getView(R.id.img_house));
        }
    }
...
//                    startActivity(intent);
                    ...
                    Toast.makeText(HaiWaiDetailsActivity.this, "百度地图未安装或版本过低", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.img_start:
    ...
    private void initStart() {
        HttpParams params = new HttpParams();
        params.put("hType", 7);//房源类型 0二手房 1新房 2租房 3土地 4别墅 5商业地产 6中国房源 7海外房源 8找团地
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(HaiWaiDetailsActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            imgStart.setImageResource(R.drawable.shoucang2);
                            Toast.makeText(HaiWaiDetailsActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                        } else {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/deletecollectionhouse")
                ...
                .execute(new DialogCallback<SuccessBean>(HaiWaiDetailsActivity.this, SuccessBean.class) {
                    ...
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            imgStart.setImageResource(R.drawable.shoucang);
                            Toast.makeText(HaiWaiDetailsActivity.this, "取消收藏成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(HaiWaiDetailsActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
