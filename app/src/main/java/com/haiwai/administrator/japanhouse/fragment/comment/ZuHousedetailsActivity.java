...
import com.haiwai.administrator.japanhouse.more.ZuBanGongMoreActivity;
import com.haiwai.administrator.japanhouse.more.ZuBieSuMoreActivity;
import com.haiwai.administrator.japanhouse.more.ZuDuoCengMoreActivity;
import com.haiwai.administrator.japanhouse.more.ZuErCengMoreActivity;
import com.haiwai.administrator.japanhouse.more.ZuShangPuMoreActivity;
import com.haiwai.administrator.japanhouse.more.ZuXueShengMoreActivity;
...
public class ZuHousedetailsActivity extends UMShareActivity {
    ...
    private void showHuxingDialog(int position) {
        ...
        Glide.with(ZuHousedetailsActivity.this).load(hxtlist.get(position).getVal()).into(img_dialog_huxing);
    }
    ...
    private void initStart() {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(ZuHousedetailsActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            ...
                            Toast.makeText(ZuHousedetailsActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    class LiebiaoAdapter extends BaseQuickAdapter<HouseDetailsBean.DatasBean.HxtlistBean, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, HouseDetailsBean.DatasBean.HxtlistBean item) {
            Glide.with(ZuHousedetailsActivity.this).load(item.getVal()).into((ImageView) helper.getView(R.id.img_huxing));
